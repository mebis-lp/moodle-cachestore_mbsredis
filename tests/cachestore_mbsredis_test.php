 ...
 */
class cachestore_mbsredis_test extends \cachestore_tests {
    /** @var cachestore_mbsredis $store Redis Cache Store. */
    protected $store;
     ...
     * @return cachestore_mbsredis
     */
    protected function create_cachestore_mbsredis(): cachestore_mbsredis {
        $definition = definition::load_adhoc(store::MODE_APPLICATION, 'cachestore_mbsredis', 'phpunit_test');
        $store = new cachestore_mbsredis('Test', cachestore_mbsredis::unit_test_configuration());
    ...
    /**
     * Test methods for various operations (set and has) in the cachestore_mbsredis class.
     *
     * @covers ::set
     * @covers ::has
     */
    public function test_has(): void {
        $store = $this->create_cachestore_mbsredis();
    ...
    /**
     * Test methods for the 'has_any' operation in the cachestore_mbsredis class.
     *
     * @covers ::set
     * @covers ::has_any
     */
    ...
    /**
     * PHPUnit test methods for the 'has_all' operation in the cachestore_mbsredis class.
     *
     * @covers ::set
     * @covers ::has_all
     */
    ...
    /**
     * Test methods for the 'lock' operations in the cachestore_mbsredis class.
     *
     * @covers ::acquire_lock
    ...
    /**
     * Test method to check if the cachestore_mbsredis instance is ready after connecting.
     *
     * @covers ::is_ready
     */
